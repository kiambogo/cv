...
\newcommand{\datesStyle}[1]{{\color{lightgray}\fontsize{8pt}{1em}\textit{#1}}}
...
% #2: optional logo [a.jpg]
% #3: location [vancouver]
% #4: subtitle [software engineer]
% #5: date(s) of entry [Jan. 2019 - PRESENT]
% #6: body
\newcommand{\cvEntry}[6]{
  \ifthenelse{\equal{#1}{}}{\vspace{-5pt}}{
    \ifthenelse{\equal{#2}{}}{}{
      \includegraphics[align=c,width=16pt,height=16pt,keepaspectratio]{#2}
    }
...
\newcommand{\mkRight}[1][0.75]{
  ...
  \newcommand{\mkExperience}{
    \mkSection[R]{Experience}{
      \cvEntry{MasonHub}{masonhub.png}{Vancouver, Canada (Remote)}{Software Engineer}{Jan. 2019 - Jan. 2021}{
        \entryItems{
          \item{Scaffolded machine-learning service to classify and mitigate spam posted throughout the site}
        }
      }
      \vspace{10pt}
      \cvEntry{Hudson's Bay Company}{hbc.png}{Vancouver, Canada (Remote)}{Lead Software Engineer}{Aug. 2018 - Jan. 2019}{
        \entryItems{
          \item{Scaffolded machine-learning service to classify and mitigate spam posted throughout the site}
        }
      }
      ...
      \vspace{10pt}
      \cvEntry{Strava}{strava.png}{San Francisco, USA}{Platform Engineer Intern}{Aug. 2015 - Dec. 2015}{
        \entryItems{
      ...
      \vspace{10pt}
      \cvEntry{Gilt Groupe}{gilt.png}{New York City, USA}{Software Engineering Intern}{Jan. 2015 - Apr. 2015}{
        \entryItems{
