...
\newcommand{\sectionTitleStyle}[1]{{\color{\myThemeColor!75}\fontsize{10pt}{1em}\MakeUppercase{\sectionTitleFont{#1}}}}
\newcommand{\subsectionTitleStyle}[1]{\fontsize{8pt}{1em}\MakeUppercase{\sectionTitleFont{#1}}}
\newcommand{\subsubsectionTitleStyle}[1]{\fontsize{6pt}{1em}{\sectionTitleFont{#1}}}
\newcommand{\experienceJobTitleStyle}[1]{{\fontsize{8pt}{1em}\bodyfont\scshape\color{gray} #1}}
\newcommand{\experienceLocationStyle}[1]{{\color{\myThemeColor!75}\fontsize{8pt}{1em}\textit{#1}}}
\newcommand{\experienceDateStyle}[1]{{\fontsize{8pt}{1em}\textit{#1}}}
...
\newcommand{\experienceItem}[6]{
  \ifthenelse{\equal{#1}{}}{\vspace{-5pt}}{
    ...
    \hfill \experienceLocationStyle{#3}\\
  }
  \experienceJobTitleStyle{#4} \hfill \experienceDateStyle{#5}\\
  {#6}
}
