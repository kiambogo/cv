...
\newcommand{\experienceItem}[5]{
  \ifthenelse{\equal{#1}{}}{\vspace{-5pt}}{
    \subsectionTitleStyle{#1} \hfill {#2}\\
  }
  \subsubsectionTitleStyle{#3} \hfill \experienceDateStyle{#4}\\
  {#5}
}
...
\newcommand{\mkRight}[1][0.75]{
  ...
  \newcommand{\mkExperience}{
    \mkSection[R]{Experience}{
      \experienceItem{MasonHub}{Vancouver, Canada (Remote)}{Founding Software Engineer}{Jan. 2019 - Jan. 2021}{
        \begin{itemize}
          \item{Scaffolded machine-learning service to classify and mitigate spam posted throughout the site}
        \end{itemize}
      }
      \experienceItem{Hudson's Bay Company}{Vancouver, Canada (Remote)}{Lead Software Engineer}{Aug. 2018 - Jan. 2019}{
        \begin{itemize}
          \item{Scaffolded machine-learning service to classify and mitigate spam posted throughout the site}
        \end{itemize}
      }
      ...
      \experienceItem{Strava}{San Francisco, USA}{Platform Engineer Intern}{Aug. 2015 - Dec. 2015}{
        \begin{itemize}
          \item{Optimized user characteristics processing with development of Scala service leveraging Spark}
