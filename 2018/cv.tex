...
%\mobile{}
%%% Social
\email{christopher.poenaru@gmail.com}
\homepage{www.chrispoenaru.com}
\github{kiambogo}
\linkedin{chrispoenaru}
%%% Optionals
\position{
  Computer Engineer{\enskip\cdotp\enskip}
  Functional Programmer{\enskip\cdotp\enskip}
  Triathlete{\enskip\cdotp\enskip}
  Rock Climber
}
...
\makecvfooter
  {\today}
  {Christopher J. Poenaru~~~·~~~Curriculum Vitae}
  {\thepage}
